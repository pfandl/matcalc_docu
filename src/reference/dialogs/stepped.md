Stepped equilibrium calculation [MatCalc Documentation]
...
4. **Step interval**:
5. **Step value**:
6. **Vary only T, no equilibrium evaluation**:
7. **Vary …**:
8. **Element**:
9. **Temperature**:
10. **Target phase**:
11. **Parent phase**:
12. **maximum Temperature step**:
13. **DFM offset**:
14. **Temperature in Celsius**:
15. **Composition in weight percent**:
16. **Append**:
17. **Append without load**:
18. **Reverse sort order**:
19. **Automatically save**:
20. **Force identical composition**:
