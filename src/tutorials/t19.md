...
The use of **scripting** to help ensure repeatability of calculations and to simplify repetitive operations has been introduced for the equilibrium calculations [Tutorial 13](/matcalc_docu/tutorials/t13 "tutorials:t13"). The present tutorial describes how scripting can be used for precipitation calculations.

### Complimentary files

Click [here](/matcalc_docu/tutorials/t19/script/t19_6021003.mcs "tutorials:t19:script:t19_6021003.mcs (28.1 KB)") to view the (slightly reordered) script for this tutorial
...
Scripts should be well commented to ensure that they can be easily understood later. See [Tutorial 13](/matcalc_docu/tutorials/t13#comments "tutorials:t13") for a reminder of how comments are inserted.
...
For an isothermal precipitation simulation, we would now simply need to set the temperature and time and start the simulation. This procedure is described briefly [below](/matcalc_docu/tutorials/t19#running_the_calculation "tutorials:t19"). However, we will here instead look at how to use a script to create a heat-treatment.
...
We saw in [Tutorial 6](/matcalc_docu/tutorials/t6 "tutorials:t6") that it is possible to define our own variables. Here, we use this functionality to define a very general script consisting of an austenitisation and a tempering step.
...
This is set up to show the phase fractions of the two precipitate phases. (See [Tutorial 5](/matcalc_docu/tutorials/t5 "tutorials:t5"))
...
[![T19 xy plots](/matcalc_docu/tutorials/t19/img/t19_xy_plots.png "T19 xy plots")](/matcalc_docu/tutorials/t19/img/t19_xy_plots.png "tutorials:t19:img:t19_xy_plots.png")

Subsequent articles
-------------------

The tutorial is continued in  [Tutorial 20 - Simulating grain growth](/matcalc_docu/tutorials/t20 "tutorials:t20")
