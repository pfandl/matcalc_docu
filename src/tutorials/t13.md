...
Click [here](/tutorials/t13/script/t13_6021003.mcs "tutorials/t13/script/t13_6021003.mcs (7.7 KB)") to view the script for this tutorial
...
1. In MatCalc, using **'File → Open'** or clicking on [![ MatCalc icon](/tutorials/t13/img/icon_open_file_2.png " MatCalc icon")](/tutorials/t13/img/icon_open_file_2.png "tutorials/t13/img/icon_open_file_2.png") icon in the toolbar (keyboard shortcut **'Ctrl + O'**). Select the filter to **'MatCalc script (\*.mcs)'** files
...
1. Using **'Script → Run script'** or clicking on [![ MatCalc icon](/tutorials/t13/img/icon_run_script.png " MatCalc icon")](/tutorials/t13/img/icon_run_script.png "tutorials/t13/img/icon_run_script.png") icon in the toolbar (keyboard shortcut **'Shift + F2'**)
2. Double-clicking on the **'.mcs'** file icon

Example: a stepped equilibrium
------------------------------

This example will show how to write a script to perform the stepped calculation in  [Tutorial 3](/tutorials/t3 "tutorials/t3") and display the results.
...
The next parts of the script are to set up the system, set the temperature and calculate an equilibrium. These commands have already been seen in [Tutorial 12](/tutorials/t12 "tutorials/t12").
...
The final part of the script is concerned with graphical presentation of results. The following line creates a new GUI window to contain the plot. As was seen in  [Tutorial 12](/tutorials/t12 "tutorials/t12"), the code **'p1'** is used to open an XY-plot.
...
[![ MatCalc plot](/tutorials/t13/img/t13_plot1_phase_stability_6011003.png " MatCalc plot")](/tutorials/t13/img/t13_plot1_phase_stability_6011003.png "tutorials/t13/img/t13_plot1_phase_stability_6011003.png")

[![ MatCalc plot](/tutorials/t13/img/t13_plot2_phase_composition_6011003.png " MatCalc plot")](/tutorials/t13/img/t13_plot2_phase_composition_6011003.png "tutorials/t13/img/t13_plot2_phase_composition_6011003.png")

Consecutive articles
--------------------

The tutorial is continued in article  [T14 - Introduction to precipitation calculations](/tutorials/t14 "tutorials/t14")
