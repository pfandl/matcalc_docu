...
[![ 'Store results every…' entry](/matcalc_docu/howtosimulate/precipitation/img/store_results_interval.png " 'Store results every…' entry")](/matcalc_docu/howtosimulate/precipitation/img/store_results_interval.png "howtosimulate:precipitation:img:store_results_interval.png")

There exists also the possibility to freeze the window content update. This can be done with clicking on the icon [![ 'Freeze all window update' icon](/matcalc_docu/howtosimulate/precipitation/img/icon_freeze_update.png " 'Freeze all window update' icon")](/matcalc_docu/howtosimulate/precipitation/img/icon_freeze_update.png "howtosimulate:precipitation:img:icon_freeze_update.png") in Toolbar or on the entry **'Freeze Update'** in menu **'View'** (this places the checkmark next to it).

[![ 'Freeze update' menu entry](/matcalc_docu/howtosimulate/precipitation/img/menu_freeze_update.png " 'Freeze update' menu entry")](/matcalc_docu/howtosimulate/precipitation/img/menu_freeze_update.png "howtosimulate:precipitation:img:menu_freeze_update.png")
...
[![ "list-simulation-parameter" output](/matcalc_docu/howtosimulate/precipitation/img/convergence_control_parameters.png " \"list-simulation-parameter\" output")](/matcalc_docu/howtosimulate/precipitation/img/convergence_control_parameters.png "howtosimulate:precipitation:img:convergence_control_parameters.png")
...
[![ Iteration limits displayed in console window](/matcalc_docu/howtosimulate/precipitation/img/console_limit_display.png " Iteration limits displayed in console window")](/matcalc_docu/howtosimulate/precipitation/img/console_limit_display.png "howtosimulate:precipitation:img:console_limit_display.png")
...
[![ "Kinetic accelerator summary" window](/matcalc_docu/howtosimulate/precipitation/img/kinetic_accelerator_summary.png " \"Kinetic accelerator summary\" window")](/matcalc_docu/howtosimulate/precipitation/img/kinetic_accelerator_summary.png "howtosimulate:precipitation:img:kinetic_accelerator_summary.png")
