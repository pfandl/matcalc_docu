...
2. [Thermodynamic equilibrium analysis for continuous casting simulation of micro-alloyed Fe-Al-C-N-Nb-Ti steel](/matcalc_docu/examples/equilib/e20 "examples:equilib:e20")
3. [Treatment of primary precipitates](/matcalc_docu/examples/precipitation/p20/p20_1 "examples:precipitation:p20:p20_1")
...
The most straightforward means to determine (or estimate) the amount of primary precipitation is the application of the Scheil-Gulliver model. It is described in some detail in the comprehensive example  [Thermodynamic equilibrium analysis for continuous casting simulation of micro-alloyed Fe-Al-C-N-Nb-Ti steel](/matcalc_docu/examples/equilib/e20 "examples:equilib:e20").
...
[![ Edit size distribution](/matcalc_docu/howtosimulate/precipitation/img/edit_precipitate_distribution.png " Edit size distribution")](/matcalc_docu/howtosimulate/precipitation/img/edit_precipitate_distribution.png "howtosimulate:precipitation:img:edit_precipitate_distribution.png")
...
[![ Generate size distribution](/matcalc_docu/howtosimulate/precipitation/img/generate_precipitate_distribution.png " Generate size distribution")](/matcalc_docu/howtosimulate/precipitation/img/generate_precipitate_distribution.png "howtosimulate:precipitation:img:generate_precipitate_distribution.png")
...
[![ Set phase fraction of parent phase](/matcalc_docu/howtosimulate/precipitation/img/parent_phase_fraction.png " Set phase fraction of parent phase")](/matcalc_docu/howtosimulate/precipitation/img/parent_phase_fraction.png "howtosimulate:precipitation:img:parent_phase_fraction.png")

Starting from the Scheil-Gulliver analysis, the size distribution of the primary precipitate can be created simply by selecting the solidified phase (the one with ‘\_S’-suffix) and creating a precipitate phase out of it. This procedure is demonstrated in  [Example P20-1: Treatment of primary precipitates](/matcalc_docu/examples/precipitation/p20/p20_1 "examples:precipitation:p20:p20_1").
...
[![ Edit size distributions](/matcalc_docu/howtosimulate/precipitation/img/fig_phase_status_edit_distribution_dlg.png " Edit size distributions")](/matcalc_docu/howtosimulate/precipitation/img/fig_phase_status_edit_distribution_dlg.png "howtosimulate:precipitation:img:fig_phase_status_edit_distribution_dlg.png")
...
* In a preliminary step, perform a ***Scheil-Gulliver simulation*** to determine the type and amount of primary precipitates in your system. See the example E20 -  [Thermodynamic equilibrium analysis for continuous casting simulation of micro-alloyed Fe-Al-C-N-Nb-Ti steel](/matcalc_docu/examples/equilib/e20 "examples:equilib:e20") for instructions on how to do this.
...
[![ Virtual heat treatment for primary precipitation](/matcalc_docu/howtosimulate/precipitation/img/fig_grow_hypothetical_ht.png " Virtual heat treatment for primary precipitation")](/matcalc_docu/howtosimulate/precipitation/img/fig_grow_hypothetical_ht.png "howtosimulate:precipitation:img:fig_grow_hypothetical_ht.png")
...
Both ways are demonstrated in the example P20 ([Example P20: Precipitation simulation during continuous casting of micro-alloyed Fe-Al-C-N-Nb-Ti steel, part 1: Treatment of primary precipitates](/matcalc_docu/examples/precipitation/p20/p20_1 "examples:precipitation:p20:p20_1")).
