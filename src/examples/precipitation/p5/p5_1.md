...
Click [here](/examples/precipitation/p5/p5-concurrentgrowth-dictra_2018.mcs "examples/precipitation/p5/p5-concurrentgrowth-dictra_2018.mcs (10.2 KB)") to view the script for this tutorial.
...
[![ Precipitation kinetics dialog window](/examples/precipitation/p5/p5_1-preckin.png " Precipitation kinetics dialog window")](/examples/precipitation/p5/p5_1-preckin.png "examples/precipitation/p5/p5_1-preckin.png")

Plotting the results
--------------------

To plot the results either load this [plot-setup script](/examples/precipitation/p5/p5-plotsetup.mcs "examples/precipitation/p5/p5-plotsetup.mcs (3.4 KB)"), or perform the following steps: create a XY-data (p1) plot for phase fraction.
...
[![ Phase fractions of stable M23C6 and meta-stable M7C3 and Cementite precipitate](/examples/precipitation/p5/p5_1-phasefraction-result.png " Phase fractions of stable M23C6 and meta-stable M7C3 and Cementite precipitate")](/examples/precipitation/p5/p5_1-phasefraction-result.png "examples/precipitation/p5/p5_1-phasefraction-result.png")
...
[![ Chromium content of Cementite over radius](/examples/precipitation/p5/p5_1-cem-result.png " Chromium content of Cementite over radius")](/examples/precipitation/p5/p5_1-cem-result.png "examples/precipitation/p5/p5_1-cem-result.png")

[![ Chromium content of M7C3 over radius](/examples/precipitation/p5/p5_1-m7c3-result.png " Chromium content of M7C3 over radius")](/examples/precipitation/p5/p5_1-m7c3-result.png "examples/precipitation/p5/p5_1-m7c3-result.png")

[![ Chromium content of M23C6 over radius](/examples/precipitation/p5/p5_1-m23c6-result.png " Chromium content of M23C6 over radius")](/examples/precipitation/p5/p5_1-m23c6-result.png "examples/precipitation/p5/p5_1-m23c6-result.png")
...
This analysis is continued in the article  [Evaluation of inner particle diffusion coefficient](/examples/precipitation/p5/p5_2 "examples/precipitation/p5/p5_2") where the influence of the inner particle diffusion ration will be elaborated.
