...
[![ Clustering of Cu - Vacancy prefers Cu-atoms](/examples/precipitation/p80/p80_mc_a_2_precfilm.gif " Clustering of Cu - Vacancy prefers Cu-atoms")](/examples/precipitation/p80/p80_mc_a_2_precfilm.gif "examples/precipitation/p80/p80_mc_a_2_precfilm.gif")
[![ Clustering of Cu - Vacancy prefers Fe-atoms](/examples/precipitation/p80/p80_mc_cu_prec_film.gif " Clustering of Cu - Vacancy prefers Fe-atoms")](/examples/precipitation/p80/p80_mc_cu_prec_film.gif "examples/precipitation/p80/p80_mc_cu_prec_film.gif")
...
[![Influence of BS-coefficient on precipitate growth](/examples/precipitation/p80/p80_coalescence_radius.png "Influence of BS-coefficient on precipitate growth")](/examples/precipitation/p80/p80_coalescence_radius.png "examples/precipitation/p80/p80_coalescence_radius.png")
[![ Influence of BS-coefficient on number density](/examples/precipitation/p80/p80_coalescence_numberdens.png " Influence of BS-coefficient on number density")](/examples/precipitation/p80/p80_coalescence_numberdens.png "examples/precipitation/p80/p80_coalescence_numberdens.png")
...
[![ Interfacial energy correction factor as a function of the regular solution critical temperature](/examples/precipitation/p80/p80_gammacorrcurve.png " Interfacial energy correction factor as a function of the regular solution critical temperature")](/examples/precipitation/p80/p80_gammacorrcurve.png "examples/precipitation/p80/p80_gammacorrcurve.png")
...
[![ Miscibility in the Fe-Cu system in Celsius and Kelvin](/examples/precipitation/p80/p80_miscibilitygap.png " Miscibility in the Fe-Cu system in Celsius and Kelvin")](/examples/precipitation/p80/p80_miscibilitygap.png "examples/precipitation/p80/p80_miscibilitygap.png")
...
[![ Manually found correction factors compared to calculated ones](/examples/precipitation/p80/p80_gamma-vergleich.png " Manually found correction factors compared to calculated ones")](/examples/precipitation/p80/p80_gamma-vergleich.png "examples/precipitation/p80/p80_gamma-vergleich.png")
...
[![ TTP Curve of Cu-precipiatates in Fe](/examples/precipitation/p80/p80_ttp_vergleich_model_manually_v2.png " TTP Curve of Cu-precipiatates in Fe")](/examples/precipitation/p80/p80_ttp_vergleich_model_manually_v2.png "examples/precipitation/p80/p80_ttp_vergleich_model_manually_v2.png")
...
[![ Precipitation and Transformation sequence in Fe-Cu](/examples/precipitation/p80/p80_prec-sequence.png " Precipitation and Transformation sequence in Fe-Cu")](/examples/precipitation/p80/p80_prec-sequence.png "examples/precipitation/p80/p80_prec-sequence.png")

Minimum nucleation energy G\* calculation
-----------------------------------------

The calculation and background on min G\* have already been covered [elsewhere](/howtosimulate/physical/mingstar "howtosimulate/physical/mingstar").

Feel free to also consult examples [E10](/examples/equilib/e10 "examples/equilib/e10") and in future E11 for more information on minimum nucleation energy.
...
[![Minimum G* evaluation as a function of Temperature and Cu-content in Fe-Cu system](/examples/precipitation/p80/p80_g-star.png "Minimum G* evaluation as a function of Temperature and Cu-content in Fe-Cu system")](/examples/precipitation/p80/p80_g-star.png "examples/precipitation/p80/p80_g-star.png")
...
[![Calculated nucleation probability](/examples/precipitation/p80/p80_p-nucl.png "Calculated nucleation probability")](/examples/precipitation/p80/p80_p-nucl.png "examples/precipitation/p80/p80_p-nucl.png")
...
The here elaborated models and parameters will be set to use in the following example  [P80\_2 - Precipitation of Cu in Fe-Cu](/examples/precipitation/p80/p80_2 "examples/precipitation/p80/p80_2")
