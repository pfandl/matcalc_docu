...
Click [here (25)](/examples/precipitation/p1/lsw_-_new-_25classes_2018.mcs "examples/precipitation/p1/lsw_-_new-_25classes_2018.mcs (6.8 KB)") to view the script for this example with #25 size classes, and [here (1000)](/examples/precipitation/p1/lsw_-_new_-_1000_classes_2018.mcs "examples/precipitation/p1/lsw_-_new_-_1000_classes_2018.mcs (7.3 KB)") for the script with #1000 size classes.

Click [here](/examples/precipitation/p1/p1_lsw-plot_2018.mcs "examples/precipitation/p1/p1_lsw-plot_2018.mcs (3.4 KB)") to view the script for the plots.
...
[![](/examples/precipitation/p1/p1-1.png)](/examples/precipitation/p1/p1-1.png "examples/precipitation/p1/p1-1.png")
...
[![Create a new precipitate](/examples/precipitation/p1/p1_phasestatus_1.png "Create a new precipitate")](/examples/precipitation/p1/p1_phasestatus_1.png "examples/precipitation/p1/p1_phasestatus_1.png")
...
[![](/examples/precipitation/p1/p1-2.png)](/examples/precipitation/p1/p1-2.png "examples/precipitation/p1/p1-2.png")
...
In the actual simulation procedure, you do not have to think about the actual handling of the precipitate size distribution, as this is managed internally by *MatCalc*. However, if you are interested in this functionality in more detail, have a look at the  [primary precipitates HowTo](/howtosimulate/precipitation/primary_prec#manually_defined_size_distributions "howtosimulate/precipitation/primary_prec"), especially the manually defined size distributions section.

As a last step, change the nucleation site from bulk to dislocation in the 'Nucleation' tab:

[![](/examples/precipitation/p1/p1-3.png)](/examples/precipitation/p1/p1-3.png "examples/precipitation/p1/p1-3.png")
...
[![LSW function](/examples/precipitation/p1/p1_functions.png "LSW function")](/examples/precipitation/p1/p1_functions.png "examples/precipitation/p1/p1_functions.png")

Setup the plots
---------------

To display the results of this example, we need 3 windows with several plots. As a shortcut, feel free to download and execute the ['plot' script](/examples/precipitation/p1/p1_lsw-plot.mcs "examples/precipitation/p1/p1_lsw-plot.mcs (3.5 KB)"). It should setup all 3 windows and name everything accordingly if you named all your variables as shown in this example.
...
[![](/examples/precipitation/p1/p1-4.png)](/examples/precipitation/p1/p1-4.png "examples/precipitation/p1/p1-4.png")
...
[![ Result of P1 showing: Phase fraction, number density, nucleation rate and precipitate radius](/examples/precipitation/p1/p1-final-fnjr-25classes.png " Result of P1 showing/ Phase fraction, number density, nucleation rate and precipitate radius")](/examples/precipitation/p1/p1-final-fnjr-25classes.png "examples/precipitation/p1/p1-final-fnjr-25classes.png")

[![ Precipitate distribution calculated with #25 size classes](/examples/precipitation/p1/p1-distribution-25classes.png " Precipitate distribution calculated with #25 size classes")](/examples/precipitation/p1/p1-distribution-25classes.png "examples/precipitation/p1/p1-distribution-25classes.png")

Consecutive articles
====================

The analysis of this example will be continued in  [Setup of simulation for analysis of precipitate distributions](/examples/precipitation/p1/p1_2 "examples/precipitation/p1/p1_2").
