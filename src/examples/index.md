...
* **E1** -  [Stable and meta-stable phase fraction diagram of Fe-C-Mn](/matcalc_docu/examples/e1 "examples:e1") - Evaluate ortho-equilibrium and para-equilibrium phase fraction diagrams.
...
* **P1** -  [Precipitation of XXX in YYY](/matcalc_docu/examples/p1 "examples:p1") - asf asdf asdf
* **P2** -  [???](/matcalc_docu/examples/p2 "examples:p2") - asdf asdf asdf adfssdfds
* **P10** -  [AlN precipitation in steel](/matcalc_docu/examples/p10 "examples:p10") - Heterogeneous precipitation of AlN at dislocations and grain boundaries. Simulation and experimental verification.
* **P11** -  [Concurrent precipitation of AlN and VN in steel](/matcalc_docu/examples/p11 "examples:p11") - A computational study and comparison with experiment
* **P12** -  [NbC precipitation in steel](/matcalc_docu/examples/p12 "examples:p12") - Interaction between precipitation and deformation
* **P20** -  [Precipitation simulation during continuous casting](/matcalc_docu/examples/p20 "examples:p20") - Precipitation in primary solidification microstructure
* **P30** -  [TTP-plot of micro-alloying precipitates in Fe-Al-Nb-Ti-C-N](/matcalc_docu/examples/p30 "examples:p30") - Isothermal conditions.
* **P31** -  [TTP-plot of micro-alloying precipitates in Fe-Al-Nb-Ti-C-N](/matcalc_docu/examples/p31 "examples:p31") - Advanced programming including primary precipitates and deformation
...
* **P100** -  [Precipitation strengthening in Fe-Cu](/matcalc_docu/examples/p100 "examples:p100")
* **P110** -  [Yield strength prediction in 6xxx alloys](/matcalc_docu/examples/p110 "examples:p110")
* bla bla bla
...
* **D1** -  [Fe-C diffusion couple](/matcalc_docu/diffusion/d1 "diffusion:d1") - Carbon diffusion in austenite
* **D2** -  [Simple carburization treatment](/matcalc_docu/diffusion/d2 "diffusion:d2") - Diffusion of C into austenite
* **D3** -  [Fe-C-Mn-Si diffusion couple](/matcalc_docu/diffusion/d3 "diffusion:d3") - The famous Darken uphill diffusion experiment

### Diffusion in dispersed systems - Local equilibrium approach

* **D10** -  [Simultaneous long-range diffusion and second-phase formation](/matcalc_docu/diffusion/d10 "diffusion:d10") - XXXXX

### Simultaneous long-range diffusion and precipitation

* **D20** -  [Simultaneous long-range diffusion and precipitation](/matcalc_docu/diffusion/d20 "diffusion:d20") - XXXXX
...
* **H1** -  [Heating a block of metal](/matcalc_docu/thermal/t1 "thermal:t1")
* **H2** -  [Quenching a block of metal](/matcalc_docu/thermal/t2 "thermal:t2")
