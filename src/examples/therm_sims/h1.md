...
Click  [here](/matcalc_docu/examples/therm_sims/h1/script/h1.mcs "examples:therm_sims:h1:script:h1.mcs (7.8 KB)") to view the script for this tutorial.
...
[![ Grid window](/matcalc_docu/examples/therm_sims/h1/img/grid0smarked.gif " Grid window")](/matcalc_docu/examples/therm_sims/h1/img/grid0smarked.gif "examples:therm_sims:h1:img:grid0smarked.gif")  
...
[![ Grid window](/matcalc_docu/examples/therm_sims/h1/img/grid0smarked2.gif " Grid window")](/matcalc_docu/examples/therm_sims/h1/img/grid0smarked2.gif "examples:therm_sims:h1:img:grid0smarked2.gif")  
...
[![ Time evolution of the oven temperature](/matcalc_docu/examples/therm_sims/h1/img/oventemp.gif " Time evolution of the oven temperature")](/matcalc_docu/examples/therm_sims/h1/img/oventemp.gif "examples:therm_sims:h1:img:oventemp.gif")  
...
[![ After 100 seconds](/matcalc_docu/examples/therm_sims/h1/img/grid100sec.gif " After 100 seconds")](/matcalc_docu/examples/therm_sims/h1/img/grid100sec.gif "examples:therm_sims:h1:img:grid100sec.gif")[![ After 203 seconds](/matcalc_docu/examples/therm_sims/h1/img/grid203sec.gif " After 203 seconds")](/matcalc_docu/examples/therm_sims/h1/img/grid203sec.gif "examples:therm_sims:h1:img:grid203sec.gif")  
...
[![ After 600 seconds](/matcalc_docu/examples/therm_sims/h1/img/grid600sec.gif " After 600 seconds")](/matcalc_docu/examples/therm_sims/h1/img/grid600sec.gif "examples:therm_sims:h1:img:grid600sec.gif")[![ After 1210 seconds](/matcalc_docu/examples/therm_sims/h1/img/grid1210sec.gif " After 1210 seconds")](/matcalc_docu/examples/therm_sims/h1/img/grid1210sec.gif "examples:therm_sims:h1:img:grid1210sec.gif")  
...
[![ Temperature distribution of cells according to figure 1](/matcalc_docu/examples/therm_sims/h1/img/alltimesplot.gif " Temperature distribution of cells according to figure 1")](/matcalc_docu/examples/therm_sims/h1/img/alltimesplot.gif "examples:therm_sims:h1:img:alltimesplot.gif")  
...
[![ Time evolution of cells marked in figure 2](/matcalc_docu/examples/therm_sims/h1/img/historyplot.gif " Time evolution of cells marked in figure 2")](/matcalc_docu/examples/therm_sims/h1/img/historyplot.gif "examples:therm_sims:h1:img:historyplot.gif")  
