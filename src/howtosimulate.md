MatCalc 'How to ...' manual [MatCalc Documentation]



### Table of Contents

* [MatCalc 'How to ...' manual](#matcalc_how_to__manual)

  + [Equilibrium and non-equilibrium thermodynamics](#equilibrium_and_non-equilibrium_thermodynamics)
  + [Kinetic simulation](#kinetic_simulation)
  + [Physical parameter calculation](#physical_parameter_calculation)

MatCalc 'How to ...' manual
===========================

This document provides useful hints, recipes and strategies on 'how to' setup simulations efficiently and correctly. It will discuss general considerations for the simulation setup and tries to avoid typical traps and error that one can tap into when using the MatCalc simulation modules.

How to perform a simulations for …
